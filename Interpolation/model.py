...
def main(train_images, test_images=None, train=True, outputs='interpolation', load="", total_epochs=50, batch_size=32):
...
if __name__ == '__main__':
    ...
    main(train_images, test_images, train = False, outputs=outputs, load=outputs, total_epochs=100, batch_size=16)